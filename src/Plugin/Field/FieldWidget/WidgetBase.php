...
/**
 * @file
 * Contains \Drupal\multiple_selects\Plugin\Field\FieldWidget\WidgetBase.
 */
...
/**
 * Base class for the 'multiple_selects_*' widgets.
 *
 * Field types willing to enable one or several of the widgets defined in
 * multiple_selects.module (select, radios/checkboxes, on/off checkbox) need to
